-- Copy this file to create your own custom themes, but please do not modify this file.
    ...
    return {
       ...
       -- flat buttons
       CLICKABLE = 0x000000,
       CLICKABLE_HOVER = 0x008080,             -- Color when hovering over the tab with mouse
       ...
       -- for 3D surfaces
       THREE_D_HIGHLIGHT = 0x008080,            -- Color of outside-most window border color, resizer, tab borders, and scrollbar highlights
    
       THREE_D_GRADIENT = miniwin.gradient_vertical,
       THREE_D_GRADIENT_FIRST = 0x000000,
       THREE_D_GRADIENT_SECOND = 0x008080,
       ...
       SCROLL_TRACK_COLOR2 = 0x008080,          -- Main color of scrollbar
