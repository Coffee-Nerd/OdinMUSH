...
return {
   ...
   -- flat buttons
   CLICKABLE = 0x8E2DE2,
   CLICKABLE_HOVER = 0x4A00E0,             -- Color when hovering over the tab with mouse
   CLICKABLE_HOT = 0x8E2DE2,               -- Color when you have an unread message
   ...
   -- for 3D surfaces
   THREE_D_HIGHLIGHT = 0x422527,            -- Color of outside-most window border color, resizer, tab borders, and scrollbar highlights

   THREE_D_GRADIENT = miniwin.gradient_vertical,
   THREE_D_GRADIENT_FIRST = 0x8E2DE2,
   THREE_D_GRADIENT_SECOND = 0x4A00E0,
   THREE_D_GRADIENT_ONLY_IN_TITLE = false,

   THREE_D_SOFTSHADOW = 0x250808,
   THREE_D_HARDSHADOW = 0x8E2DE2,           -- Partial color of resizer, inner border of title windows, bottom/right color of scroller
   THREE_D_SURFACE_DETAIL = 0xFFFFFF,       -- for contrasting details/text drawn on 3D surfaces -TEXT COLOR-

   -- for scrollbar background
   SCROLL_TRACK_COLOR1 = 0x8E2DE2,          -- Color of diagonal lines on scrollbar
   SCROLL_TRACK_COLOR2 = 0x4A00E0,          -- Main color of scrollbar
